...
//    private static String wordsFileDir ="/home/xiaoming/newsLearn/news_train_fudan/";
    ...
    public static Integer compareNewsCategory(String content){
        content="冬的长袖一挥，寒风便萧萧而来，白雪便纷然而落。冬大气凛然的气场总是没有任何季节可以比拟。 假如，寒冷刺骨的冬还有一抹温柔的气息，那么这气息当属于雪花。 天苍苍，野茫茫，随处飘散的雪花，如精灵曼舞，洁白的颜色是这个冬季唯一的统治。 冬夜伏案，被雪花细细的声音吸引，那是天空之城发出的最洁白，最妩媚的声音。 冬是寂静的，却有着一份雪白的温度。当冬孤单的时候，却有一朵雪花静静陪伴着它。 雪，那么宁静那么典雅，不含一丝杂质。雪花从天空飞舞而下的那一刻，既是盛开，也是凋谢。 或许，世间只有这朵雪之花，能将绽放和飘零同时演绎得如此唯美。 站立在松枝下，听冬雪沙沙，听雪的灵魂在低低私语。此时天是白的，地是白的，心灵的旷野也被一朵朵雪花温柔的染白。 如果这雪花能够唤醒梅花的魂，如果这雪能够抚慰山间的松涛，如果这雪能够纾解我的心，我便认为它就是一朵美丽的花。 狂风大作时，落雪宛如一笺奋笔疾书的狂草。静谧无风时，落雪犹如一个女子静静书写的梅花小字，精致，耐看，飘逸，婉约。 冬夜里握茶取暖，或者握字暖心，都是幸福的时光。屋里的灯光暖暖的黄，屋外的雪花静静的白，此时的时光多么的柔软静美。 一朵雪花，无牵无挂，无欲无求，风起而行，风静而憩。有时候人不如一朵雪花，来去天涯，无挂无牵。 岁月的锦衣，莫如一朵白雪披身，心灵两岸的光阴，被白雪映照成一份洁白素简。 生命最好的状态，莫过于与自然融为一体，人生最好的境界，莫过于用自然的白色洗净心灵的雪白。 每一个生命都希望葳蕤成树，或花香淡淡，有时却又不得不像一朵雪花一样流浪着自己，沉默着自己，漂泊着自己。 我无数次在笔尖追问：我的岁月到何处去了？当我面对这一空茫茫的雪花，原来我的一切都融入了这时光的苍茫里。 一个人只有在孤独的时候，才能与灵魂里的另一个自己相遇。无论生命怎样的短暂，只求无埃无尘，只求无怨无悔。 虽然身居北方，心却活着江南的姿态，总希望能够拈笔写出江南一样味道的小文。能够安静的活着，能够提笔为诗，能够采梅泡茶，那日子便是清清莹莹的好。 时光，一晃便匆匆。人生须臾，恰如雪花一阵。相遇不易，珍惜生命里经过的每一个人，无论亲人还是朋友。 有些人倏然的来过，犹如一盏茶由沸腾至微凉的须臾，犹如雪花从天而落的短暂。如果有一种结局先于落雪而来，那么我无憾。 一空雪花洋洋洒洒，叫人在宁静的夜晚陷入往事的追忆。或许唯有在这样一份飘渺忧伤的回忆里，我们才能暂且放下一颗为生活奔忙的心，寻到一抹淡淡的慰藉…… 雪花恰如一位匆匆的过客，在相互遇到的时候，留下彼此最美丽的样子，哪怕就此擦肩，也无憾这一场心灵的碰撞。 在白雪的时光里，偷偷爱过一个人，即便他没有参与到你的爱情中来，却也美丽了一份生命爱的遐想。 每个人心中都有不得不放下的美丽，不得不埋藏的遗憾。不，那不是真正的放下，而是在另一个灵魂的世界里留存。 时光的掌纹里写着一笔美好，同样写着一份寂寞与心碎。美丽的曾经，有过一个就足够。 一朵雪花无心的飘落，却惹了红尘里那颗多情的心儿牵牵缠缠。假如我不能像一朵雪花共伴你左右，就让我在你心底堆满温暖的记忆。 我是一朵为爱行走的雪花，我耽溺在红尘，只为你心房里为我跳动的一份暖。我愿涉寒风而来，携一首短诗，和你心灵最干净的笛音…… 假如你爱一个人，你无须拥有他，你只需用一颗花香的心，在他的心路上踩出一些印记，你便成了他的不可相忘。 迎风读雪，雪却莹白了灵魂。迎雪写诗，诗却留白了裙魅。时光不堪握，等待令人老。假如今生你已错过了我的芬芳，请不要再错过我的雪白……";
        Integer nearCategoryId = null;
        for(int i = 0;i < allCategoryWordList.size();i++){
            NbcWordsMap nbcWordsMap = allCategoryWordList.get(i);
            Map<String,Integer> newsWordMap = choutiSegment.segmentFrequency(content);
//            Map<String,Integer> newsWordMap = choutiSegment.segmentTextRank(content,15);
