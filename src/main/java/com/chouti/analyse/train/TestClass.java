...
//    private static String wordsFileDir ="/home/xiaoming/newsLearn/news_train_fudan/";
    ...
    public static Integer compareNewsCategory(String content){
        content="当然，升级到 Windows 10 预览版的前提是首先必须要成为 Windows Insider 会员。在注册成功并确保设备可更新到新系统后，大家可以手动检查更新，外媒建议使用“控制面板”，不过“设置”选项应该也可以检查更新。 据外媒 Neowin 表示，这个升级过程耗时比较长，尤其是微软服务器目前又处于高负载运行压力下，估计速度会更加缓慢，因为“Windows 更新”一般来说不会占尽所有的系统资源。因此，提醒打算通过“Windows 更新”来升级 Windows 7/8.1 到 Windows 10 的用户，参考外媒 Neowin 花费的整整 6 个小时更新用时，大家要做好长时间等待的准备。 在完成更新下载并成功解压之后，需要重启电脑，然后电脑会进入常规的更新阶段。在更新完成以后，你会发现之前安装的所有程序仍可正常运行，而之前的大部分设置也基本得到保存，因此整个更新几乎完成了一次无缝式的升级。当然，这是在不触发 Build 9926 版本的 Bug 前提之下。 外媒 Neowin 发现，这个新的更新方式同样存在于 Windows 10 Build 9926 版本中，该版本升级至新 Build 版本的功能现在已经被集成至“Windows 更新”中。如此看来，微软显然在计划让所有用户都能够无缝升级到 Windows 10 最新版本。不知道已经更新系统的 Windows 7/8.1 用户，是否有人通过这种新方式顺利升级到 Windows 10？ 安装工具:Windows 7 | Windows 8.1 活动入口: 微软中国官方商城 - 教师节感恩套餐限时活动已开启 最高立省¥1097！";
